                                ...
                                @foreach($mahasiswa2 as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/mahasiswa/bayar/' . $item->id . '/edit') }}" title="Bayar Mahasiswa2"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Bayar</button></a>
